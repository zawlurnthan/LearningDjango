...
def create_question(question_text, days):
    """
    Create a question with the given 'question_text' and published the given number of 'days' offset to new
    ...
    # create a question with a different published time in the future or past to check.
